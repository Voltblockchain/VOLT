...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            VOLTGUI* window = static_cast<VOLTGUI*>(parentWidget());
...
{
    VOLTGUI* gui = static_cast<VOLTGUI*>(parentWidget());
...
{
    hide();
    static_cast<VOLTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your VLTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
