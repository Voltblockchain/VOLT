...
/* VOLT GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VOLT"
#define QAPP_ORG_DOMAIN "volt.org"
#define QAPP_APP_NAME_DEFAULT "VOLT-Qt"
#define QAPP_APP_NAME_TESTNET "VOLT-Qt-testnet"
