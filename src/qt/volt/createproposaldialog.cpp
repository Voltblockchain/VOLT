...
#include "qt/volt/createproposaldialog.h"
#include "qt/volt/forms/ui_createproposaldialog.h"

#include "qt/volt/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(VOLTGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.volt/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 VLT");
