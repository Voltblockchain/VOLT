...
#include "qt/volt/forms/ui_masternodewizarddialog.h"
    ...
    mnModel(_mnModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a VOLT Masternode you must dedicate %1 (the unit of VOLT) "
