...
#include "qt/volt/sendcustomfeedialog.h"
#include "qt/volt/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VOLTGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VOLTGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
