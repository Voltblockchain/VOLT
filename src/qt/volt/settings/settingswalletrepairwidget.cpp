...
#include "qt/volt/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/volt/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VOLTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to VOLTGUI::handleRestart()
