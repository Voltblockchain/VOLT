...
#include <QWidget>
#include "qt/volt/pwidget.h"
#include "qt/volt/settings/settingsbackupwallet.h"
#include "qt/volt/settings/settingsexportcsv.h"
#include "qt/volt/settings/settingsbittoolwidget.h"
#include "qt/volt/settings/settingssignmessagewidgets.h"
#include "qt/volt/settings/settingswalletrepairwidget.h"
#include "qt/volt/settings/settingswalletoptionswidget.h"
#include "qt/volt/settings/settingsmainoptionswidget.h"
#include "qt/volt/settings/settingsdisplayoptionswidget.h"
#include "qt/volt/settings/settingsinformationwidget.h"
#include "qt/volt/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(VOLTGUI* parent);
    ~SettingsWidget();
