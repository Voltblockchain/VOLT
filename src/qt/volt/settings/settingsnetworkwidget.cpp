...
#include "qt/volt/settings/settingsnetworkwidget.h"
#include "qt/volt/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/volt/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(VOLTGUI* _window, QWidget *parent) :
