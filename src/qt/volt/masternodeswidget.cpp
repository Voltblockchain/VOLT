...
#include "qt/volt/forms/ui_masternodeswidget.h"

#include "qt/volt/qtutils.h"
#include "qt/volt/mnrow.h"
#include "qt/volt/mninfodialog.h"
#include "qt/volt/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(VOLTGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::VLT)));
        return;
    }
    showHideOp(true);
