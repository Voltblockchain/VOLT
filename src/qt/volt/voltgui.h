...
#ifndef VOLT_CORE_NEW_GUI_VOLTGUI_H
#define VOLT_CORE_NEW_GUI_VOLTGUI_H
...
#include "qt/volt/navmenuwidget.h"
#include "qt/volt/topbar.h"
#include "qt/volt/dashboardwidget.h"
#include "qt/volt/send.h"
#include "qt/volt/receivewidget.h"
#include "qt/volt/addresseswidget.h"
#include "qt/volt/coldstakingwidget.h"
#include "qt/volt/governancewidget.h"
#include "qt/volt/masternodeswidget.h"
#include "qt/volt/snackbar.h"
#include "qt/volt/settings/settingswidget.h"
...
/**
  VOLT GUI main class. This class represents the main window of the VOLT UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VOLTGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VOLTGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~VOLTGUI();
...
#endif //VOLT_CORE_NEW_GUI_VOLTGUI_H
