...
/** Utility functions used by the VOLT Qt UI.
 */
namespace GUIUtil
{
...
// Render VOLT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZvlt = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZvlt = false);
...
// Parse "volt:" URI into recipient object, return true on successful parsing
