...
{
    const char* pszTimestamp = "Ethereum Foundation reportedly investigated by state authority";
    const CScript genesisOutputScript = CScript() << ParseHex("04b10d83c2703cbf322f7dbd63db5855ad7c20bd055814cd121ba32607d573b8810c02c0582abd05b4deb9c4b77b26d92428c61256cd42774babda0a073b2ed0c9") << OP_CHECKSIG;
...
static MapCheckpoints mapCheckpoints = {
    {0, uint256S("0x00000a2808224953a0e6b60aab9dede78066351729472d5633f1f23b4f2212ce")},
    {1572, uint256S("0xdc7180727a686f8c44bbd8b5880a810ea180c4e0f520671ec7361e76b8deddab")},
    {3216, uint256S("0xf1eb3ee760780af28716f70f611b2b1ca26a3582dd4de4dbb9d0be08fa07b2f2")},
    {4955, uint256S("0x23d1cad67253a533d9bfe18613a1fe4371c2b66310ea4bfcabc9eb3f5d68a313")},
};

static const CCheckpointData data = {
    &mapCheckpoints,
    1711684335, // * UNIX timestamp of last checkpoint block
    9802,       // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1711193247, 2463117, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a2808224953a0e6b60aab9dede78066351729472d5633f1f23b4f2212ce"));
        assert(genesis.hashMerkleRoot == uint256S("0xe90ae683b821d634ba15c719d2b67daf5877413eb86e28ba320011f66958533d"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04031a5868fdb2d99bd0daf6dcb1760dd5cad9785a07eed4a4e7020b58a122bacab2c48074e8b5a48805f8cad964f68b3eadcdfabc71441756e351669c6c6820bd";
        consensus.strSporkPubKeyOld = "04031a5868fdb2d99bd0daf6dcb1760dd5cad9785a07eed4a4e7020b58a122bacab2c48074e8b5a48805f8cad964f68b3eadcdfabc71441756e351669c6c6820bd";
        consensus.nTime_EnforceNewSporkKey = 1711193247; //!> Saturday, March 23, 2024 4:57:27 PM GMT+05:30
        consensus.nTime_RejectOldSporkKey = 1711452600;  //!> Tuesday, March 26, 2024 5:00:00 PM GMT+05:30
        ...
        vSeeds.emplace_back("139.59.142.109", true);
        vSeeds.emplace_back("46.101.108.156", true);
        vSeeds.emplace_back("104.248.29.44", true);
        vSeeds.emplace_back("104.248.21.205", true);
        vSeeds.emplace_back("46.101.98.149", true);
        vSeeds.emplace_back("170.64.232.197", true);
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "vltks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("volt-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("volt-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet volt addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet volt script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet volt BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet volt BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet volt BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "vltktestsapling";
