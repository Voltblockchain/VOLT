...
#error Client version information missing: version is not defined by volt-config.h or in any other way
#endif
...
/**
 * voltd-res.rc includes this file, but it cannot cope with real c++ code.
