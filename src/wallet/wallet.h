...
#ifndef VOLT_WALLET_H
#define VOLT_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_VOLT = 61000, // inherited version..
...
public:
     ...
     * VOLT: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 VLT output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CVltStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
