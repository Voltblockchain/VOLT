...
bool IsBlockPayeeValid(const CBlock& block, const CBlockIndex* pindexPrev)
{
    ...
    if (nBlockHeight == 55000 || nBlockHeight == 120000 || nBlockHeight == 200000 || nBlockHeight == 300000 || nBlockHeight == 400000 || nBlockHeight == 500000 || nBlockHeight == 650000 || nBlockHeight == 800000 || nBlockHeight == 1000000) {
    ...
    if (nBlockHeight == 54999 || nBlockHeight == 119999 || nBlockHeight == 199999 || nBlockHeight == 299999 || nBlockHeight == 399999 || nBlockHeight == 499999 || nBlockHeight == 649999 || nBlockHeight == 799999 || nBlockHeight == 999999) {
    ...
    if (nBlockHeight == 55201 || nBlockHeight == 120201 || nBlockHeight == 200201 || nBlockHeight == 300201 || nBlockHeight == 400201 || nBlockHeight == 500201 || nBlockHeight == 650201 || nBlockHeight == 800201 || nBlockHeight == 1000201) {
        SporkId nSporkID = sporkManager.GetSporkIDByName("SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT");
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txCoinbase, CMutableTransaction& txCoinstake, const CBlockIndex* pindexPrev, bool fProofOfStake) const
{
    ...
    // Starting from VOLT v6.0 masternode and budgets are paid in the coinbase tx
