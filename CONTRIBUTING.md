Contributing to VOLT Core
============================

The VOLT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/volt-project/volt/blob/master/doc/translation_process.md)
...
The following applies to code changes to the VOLT Core project, and is not to be
confused with overall VOLT Network Protocol consensus changes.

Whether a pull request is merged into VOLT Core rests with the project merge
...
Patches that change VOLT consensus rules are considerably more involved than
...
Where a patchset proposes to change the VOLT consensus, it must have been
...
The project leader is the release manager for each VOLT Core release.
