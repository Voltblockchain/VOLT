...
The build script we'll be using is contained in the VOLT github repository ([contrib/gitian-build.py](https://github.com/volt-project/volt/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the VOLT repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/VOLT-Project/VOLT/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, volt-detached-sigs, and volt GitHub repos.
