VOLT Core version v5.1.0 is now available from:  <https://github.com/volt-project/volt/releases>
...
- #2170 Better volt.conf Masternode data error notification (furszy)
