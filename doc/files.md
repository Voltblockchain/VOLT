...
volt.conf           | contains configuration settings for voltd or volt-qt
voltd.pid           | stores the process id of voltd while running
...
debug.log           | contains debug information and general logging generated by voltd or volt-qt
