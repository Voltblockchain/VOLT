...
This document provides guidelines for internationalization of the VOLT Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to VOLT network</source>
        <translation>
            <numerusform>%n active connection to VOLT network</numerusform>
            <numerusform>%n active connections to VOLT network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `volt_en.ts` remains unchanged.
