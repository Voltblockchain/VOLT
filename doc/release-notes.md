VOLT Core version *v5.5.0* is now available from:  <https://github.com/volt-project/volt/releases>
...
VOLT Core v5.5.0 is a mandatory update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
- #2697 `4d2d7708293` Kill 'zvltchain' files and (furszy)
