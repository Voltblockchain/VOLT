...
To build VOLT Core using AFL instrumentation (this assumes that the
...
with certain assembly code from VOLT Core's code. See [developer notes on sanitizers](https://github.com/VOLT-Project/VOLT/blob/master/doc/developer-notes.md#sanitizers)
