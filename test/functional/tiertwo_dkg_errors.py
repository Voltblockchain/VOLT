...
from test_framework.test_framework import VOLTDMNTestFramework, ExpectedDKGMessages
...
class DkgErrorsTest(VOLTDMNTestFramework):

    def set_test_params(self):
        self.set_base_test_params()
        self.extra_args = [["-nuparams=v5_shield:1", "-nuparams=VOLT_v5.5:130", "-nuparams=v6_evo:130", "-debug=llmq", "-debug=dkg", "-debug=net"]] * self.num_nodes
