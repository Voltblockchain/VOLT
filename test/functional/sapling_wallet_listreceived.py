...
class ListReceivedTest (VOLTTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 VLT.
        ...
        # Send 1 VLT to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 VLT sending them all (fee is 0.1 VLT)
        ...
        # Confirm transaction (2 VLT from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 VLT, send 0.6 VLT + 0.05 VLT fee
