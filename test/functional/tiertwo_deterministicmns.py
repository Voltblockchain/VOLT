...
class DIP3Test(VOLTTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 VLT) to the operator, and (2 * 2.7 VLT) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid VOLT address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid VOLT address InvalidPayee", controller.protx_update_registrar,
