...
COIN = 100000000 # 1 VLT in satoshis
...
# Objects that map to voltd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in voltd indicates these should be deserialized as blocks
