...
class BudgetProposalTest(VOLTTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid VOLT address")
        assert_raises_rpc_error(-5, "Invalid VOLT address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 VLT allowed" % invalid_amt, self.nodes[0].preparebudget,
