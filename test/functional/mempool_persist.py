...
By default, voltd will dump mempool on shutdown and
...
class MempoolPersistTest(VOLTTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent voltd from writing mempool.dat to disk. Verify that `savemempool` fails")
