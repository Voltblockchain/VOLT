#!/usr/bin/env python3
# Copyright (c) 2020 The VOLT Core developers
...
class SaplingMempoolTest(VOLTTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 VLT note to Alice
        ...
        # miner sends another 10 VLT note to Alice
