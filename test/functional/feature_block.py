...
class FullBlockTest(VOLTTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure voltd isn't accepting b26
        ...
        # Extend the b28 chain to make sure voltd isn't accepting b28
        ...
        # VOLT: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the volt code has custom code which does so);
