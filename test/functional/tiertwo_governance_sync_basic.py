...
from test_framework.test_framework import VOLTTier2TestFramework
...
class MasternodeGovernanceBasicTest(VOLTTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.volt.org/t/test-proposal",
            2,
